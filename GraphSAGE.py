...
from torch_geometric.nn import GCNConv, global_mean_pool, GATConv, TransformerConv, GINConv, SAGEConv,SGConv
...
class Encoder(nn.Module):
    def __init__(self, in_channels, hidden_channels, pool='mean', encoder_type='GraphSAGE'):
